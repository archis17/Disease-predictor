  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-screen flex justify-center items-center bg-black bg-opacity-50 z-50 modal">
      <div className="flex flex-col justify-center items-center w-96 sm:w-2/5 h-auto bg-white rounded-lg p-5">
        ...
        <h1 className="text-3xl pb-6 font-semibold text-gray-700">Edit Profile</h1>
        <form
          onSubmit={(e) => {
            e.preventDefault()
        ...
        >
          <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
              <Select name="sex" value={data.sex} onChange={handleDashboardChange} fullWidth>
            ...
            <Grid item xs={6}>
              ...
              <Select name="diet" value={data.diet} onChange={handleDashboardChange} fullWidth>
            ...
            <Grid item xs={6}>
              ...
              <Select name="exercise" value={data.exercise} onChange={handleDashboardChange} fullWidth>
                <MenuItem value="Yoga">Yoga</MenuItem>
                <MenuItem value="Mild Exercises">Mild Excercises - Walks, Jogs</MenuItem>
                <MenuItem value="Heavy Exercises">Heavy Excercises - Running, Lifting</MenuItem>
                <MenuItem value="No">No Excercise</MenuItem>
              </Select>
            </Grid>
          </Grid>
          <Button variant="outlined" color="primary" type="submit" className="w-48">
            Submit
          </Button>
        </form>
      </div>
