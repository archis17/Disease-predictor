"use client"
import { TextField, Button, Container, Grid, InputLabel, Divider, MenuItem, Select, FormControl } from "@mui/material"

const PatientForm = ({ profileData, handleInputChange, handleFormSubmit, patientData }) => {
  if (patientData.new_patient) {
    return (
      <div className="my-5 flex flex-col justify-center">
        <div className="flex justify-center">
          <h2 className="m-2 heading p-6 w-4/5 text-3xl text-gray-700 text-center">Empowering Your Health Journey</h2>
        </div>
        <Container>
          <form onSubmit={handleFormSubmit}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <InputLabel sx={{ fontSize: "1.05rem", pl: "8px" }}>Date of Birth</InputLabel>
                <Divider sx={{ my: 0.5 }} />
              </Grid>
              <Grid item xs={4}>
                <TextField
              ...
              <Grid item xs={6}>
                <FormControl variant="outlined" fullWidth>
                  ...
                  >
                    ...
                    <MenuItem value="Mild">Mild-Exercises - Walks, Jogs</MenuItem>
                    <MenuItem value="Heavy">Heavy-Exercises - Running, Lifting</MenuItem>
            ...
            <div className="buttonContainer mt-5 w-full">
              <Button type="submit" variant="outlined" color="primary" className="w-1/6 h-12">
                Submit
              </Button>
            </div>
          </form>
